...
func TestGetLedgers(t *testing.T) {
	...
	t.Run("returns ledgers info", func(t *testing.T) {
		...
		headers := map[string]string{
			...
			"API-Sign": utils.Signature("/0/private/Ledgers", values, secret),
		}

		request, _ := http.NewRequest(http.MethodPost, "https://api.kraken.com/0/private/Ledgers", strings.NewReader(values.Encode()))
